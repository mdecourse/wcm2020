// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.8.0-edge.886615d0f95bf5a752d6409b1109a3a4f9974912.
...
(function dartProgram() {
  ...
  V = {
    main: function() {
      var t3, entryPoint, timer,
        t1 = V.Game$(),
        t2 = H.interceptedTypeCheck(W.Element_Element$html("<canvas/>", null, null), "$isCanvasElement");
      t1.board = t2;
      t2.width = 300;
      t2.height = 600;
      t2 = $.Game_ctx = t2.getContext("2d");
      t2.fillStyle = "grey";
      t3 = t1.board;
      t2.fillRect(0, 0, t3.width, t3.height);
      entryPoint = document.querySelector("#tetris_output");
      entryPoint.appendChild(t1.board);
      entryPoint.appendChild(t1.gameScore);
      timer = P.Timer_Timer$periodic(new P.Duration(500000), t1.get$updateGame());
      t1.currentBlock = t1.getRandomPiece$0();
      t1.handleKeyboard$1(timer);
      return;
    },
    Game$: function() {
      var t1 = new V.Game();
    ...
    Block: function Block(t0) {
      this.tiles = t0;
      this.color = this.rotationTile = null;
    },
    Block_move_closure: function Block_move_closure() {
    },
    Block_move_closure0: function Block_move_closure0() {
    },
    Block_move_closure1: function Block_move_closure1() {
    },
    Block_move_closure2: function Block_move_closure2() {
    },
    Block_rotateRight_closure: function Block_rotateRight_closure(t0) {
      this.$this = t0;
    },
    Block_rotateLeft_closure: function Block_rotateLeft_closure(t0) {
      this.$this = t0;
    },
    IBlock: function IBlock(t0) {
      this.tiles = t0;
      this.color = this.rotationTile = null;
    },
    OBlock: function OBlock(t0) {
      this.tiles = t0;
      this.color = this.rotationTile = null;
    },
    JBlock: function JBlock(t0) {
      this.tiles = t0;
      this.color = this.rotationTile = null;
    },
    LBlock: function LBlock(t0) {
      this.tiles = t0;
      this.color = this.rotationTile = null;
    },
    TBlock: function TBlock(t0) {
      this.tiles = t0;
      this.color = this.rotationTile = null;
    },
    ZBlock: function ZBlock(t0) {
      this.tiles = t0;
      this.color = this.rotationTile = null;
    },
    SBlock: function SBlock(t0) {
      this.tiles = t0;
      this.color = this.rotationTile = null;
    },
    ...
    Game: function Game() {
      this.currentBlock = this.gameScore = this.board = null;
    },
    Game_closure: function Game_closure() {
    },
    Game_clearRows_closure: function Game_clearRows_closure() {
    },
    Game_pieceMoving_closure: function Game_pieceMoving_closure() {
    },
    Game_pieceMoving_closure0: function Game_pieceMoving_closure0() {
    },
    Game_updateGame_closure: function Game_updateGame_closure() {
    },
    Game_handleKeyboard_closure: function Game_handleKeyboard_closure(t0, t1) {
      this.$this = t0;
      this.timer = t1;
    }
  };
  ...
  V.Block.prototype = {
    move$1: function(direction) {
      ...
      switch (direction) {
        case "left":
          C.JSArray_methods.forEach$1(_this.tiles, new V.Block_move_closure());
          break;
        case "right":
          C.JSArray_methods.forEach$1(_this.tiles, new V.Block_move_closure0());
          break;
        case "up":
          C.JSArray_methods.forEach$1(_this.tiles, new V.Block_move_closure1());
          break;
        case "down":
          C.JSArray_methods.forEach$1(_this.tiles, new V.Block_move_closure2());
          break;
      }
    },
    rotateRight$0: function() {
      C.JSArray_methods.forEach$1(this.tiles, new V.Block_rotateRight_closure(this));
    },
    rotateLeft$0: function() {
      C.JSArray_methods.forEach$1(this.tiles, new V.Block_rotateLeft_closure(this));
    }
  };
  V.Block_move_closure.prototype = {
    call$1: function(t) {
      return --H.interceptedTypeCheck(t, "$isTile").x;
    },
    $signature: 3
  };
  V.Block_move_closure0.prototype = {
    call$1: function(t) {
      return ++H.interceptedTypeCheck(t, "$isTile").x;
    },
    $signature: 3
  };
  V.Block_move_closure1.prototype = {
    call$1: function(t) {
      return --H.interceptedTypeCheck(t, "$isTile").y;
    },
    $signature: 3
  };
  V.Block_move_closure2.prototype = {
    call$1: function(t) {
      return ++H.interceptedTypeCheck(t, "$isTile").y;
    },
    $signature: 3
  };
  V.Block_rotateRight_closure.prototype = {
    call$1: function(tile) {
      var x, t1, t2, t3, t4;
      H.interceptedTypeCheck(tile, "$isTile");
      x = tile.x;
      t1 = this.$this.rotationTile;
      t2 = t1.x;
      t3 = tile.y;
      t4 = t1.y;
      tile.x = t2 - t3 + t4;
  ...
  V.Block_rotateLeft_closure.prototype = {
    call$1: function(tile) {
      var x, t1, t2, t3, t4;
      H.interceptedTypeCheck(tile, "$isTile");
      x = tile.x;
  ...
  V.Game.prototype = {
    Game$0: function() {
      ...
      this.gameScore = t1;
      t1 = P.int;
      $.Game_rowState = P.List_List$filled(20, 0, t1);
      t2 = new Array(10);
      t2.fixed$length = Array;
      t1 = H.setRuntimeTypeInfo(t2, [t1]);
      t2 = [P.List, P.int];
      t3 = H.getTypeArgumentByIndex(t1, 0);
      $.Game_boardState = new H.MappedListIterable(t1, H.functionTypeCheck(new V.Game_closure(), {func: 1, ret: t2, args: [t3]}), [t3, t2]).toList$0(0);
    },
    getRandomPiece$0: function() {
      var t1, t2;
      switch (C.C__JSRandom.nextInt$1(7)) {
        case 0:
          t1 = new Array(4);
          t1.fixed$length = Array;
          t1 = H.setRuntimeTypeInfo(t1, [V.Tile]);
          t2 = new V.IBlock(t1);
          C.JSArray_methods.$indexSet(t1, 0, new V.Tile(C.JSInt_methods.floor$0(3), -1));
          C.JSArray_methods.$indexSet(t1, 1, new V.Tile(C.JSInt_methods.floor$0(4), -1));
          C.JSArray_methods.$indexSet(t1, 2, new V.Tile(C.JSInt_methods.floor$0(5), -1));
          C.JSArray_methods.$indexSet(t1, 3, new V.Tile(C.JSInt_methods.floor$0(6), -1));
          t2.rotationTile = H.interceptedTypeCheck(t1[1], "$isTile");
          t2.color = "cyan";
          return t2;
        case 1:
          t1 = new Array(4);
          ...
          t1 = H.setRuntimeTypeInfo(t1, [V.Tile]);
          t2 = new V.OBlock(t1);
          C.JSArray_methods.$indexSet(t1, 0, new V.Tile(C.JSInt_methods.floor$0(5), -1));
          C.JSArray_methods.$indexSet(t1, 1, new V.Tile(C.JSInt_methods.floor$0(6), -1));
          C.JSArray_methods.$indexSet(t1, 2, new V.Tile(C.JSInt_methods.floor$0(5), 0));
          C.JSArray_methods.$indexSet(t1, 3, new V.Tile(C.JSInt_methods.floor$0(6), 0));
          t2.rotationTile = H.interceptedTypeCheck(t1[1], "$isTile");
          t2.color = "yellow";
          return t2;
        case 2:
          ...
          t1 = H.setRuntimeTypeInfo(t1, [V.Tile]);
          t2 = new V.JBlock(t1);
          C.JSArray_methods.$indexSet(t1, 0, new V.Tile(C.JSInt_methods.floor$0(4), 0));
          C.JSArray_methods.$indexSet(t1, 1, new V.Tile(C.JSInt_methods.floor$0(5), 0));
          C.JSArray_methods.$indexSet(t1, 2, new V.Tile(C.JSInt_methods.floor$0(6), 0));
          C.JSArray_methods.$indexSet(t1, 3, new V.Tile(C.JSInt_methods.floor$0(4), -1));
          t2.rotationTile = H.interceptedTypeCheck(t1[1], "$isTile");
          t2.color = "blue";
          return t2;
        case 3:
          ...
          C.JSArray_methods.$indexSet(t1, 1, new V.Tile(C.JSInt_methods.floor$0(5), 0));
          C.JSArray_methods.$indexSet(t1, 2, new V.Tile(C.JSInt_methods.floor$0(6), 0));
          C.JSArray_methods.$indexSet(t1, 3, new V.Tile(C.JSInt_methods.floor$0(5), -1));
          t2.rotationTile = H.interceptedTypeCheck(t1[1], "$isTile");
          t2.color = "purple";
          return t2;
        case 4:
        ...
        case 6:
          ...
          t1 = H.setRuntimeTypeInfo(t1, [V.Tile]);
          t2 = new V.SBlock(t1);
          C.JSArray_methods.$indexSet(t1, 0, new V.Tile(C.JSInt_methods.floor$0(4), -1));
          C.JSArray_methods.$indexSet(t1, 1, new V.Tile(C.JSInt_methods.floor$0(5), -1));
          C.JSArray_methods.$indexSet(t1, 2, new V.Tile(C.JSInt_methods.floor$0(5), 0));
          C.JSArray_methods.$indexSet(t1, 3, new V.Tile(C.JSInt_methods.floor$0(6), 0));
          t2.rotationTile = H.interceptedTypeCheck(t1[1], "$isTile");
          t2.color = "green";
      ...
      t1 = new Array(4);
      t1.fixed$length = Array;
      return new V.Block(H.setRuntimeTypeInfo(t1, [V.Tile]));
    },
    clearRows$0: function() {
      var idx, t1, imageData, y, y0, x, t2;
      for (idx = 0; t1 = $.Game_rowState, t1.length, idx < 20; ++idx)
        if (t1[idx] === 10) {
          imageData = P.convertNativeToDart_ImageData($.Game_ctx.getImageData(0, 0, 300, 30 * idx));
          t1 = $.Game_ctx;
          (t1 && C.CanvasRenderingContext2D_methods).putImageData$3(t1, imageData, 0, 30);
          for (y = idx; y > 0; y = y0) {
            for (y0 = y - 1, x = 0; x < 10; ++x) {
              t1 = $.Game_boardState;
              if (x >= t1.length)
                return H.ioore(t1, x);
              t1 = t1[x];
              t2 = J.getInterceptor$asx(t1);
              t2.$indexSet(t1, y, t2.$index(t1, y0));
            }
            t1 = $.Game_rowState;
            t2 = t1[y0];
            t1.length;
          ...
          t1 = $.Game_rowState;
          (t1 && C.JSArray_methods).$indexSet(t1, 0, 0);
          t1 = $.Game_boardState;
          (t1 && C.JSArray_methods).forEach$1(t1, new V.Game_clearRows_closure());
          t1 = $.Game_linesCleared;
          if (typeof t1 !== "number")
            return t1.$add();
          $.Game_linesCleared = t1 + 1;
        }
    },
    validMove$0: function() {
      var t1, _i, tile, t2, t3, t4;
      for (t1 = this.currentBlock.tiles, _i = 0; _i < 4; ++_i) {
        tile = t1[_i];
        t2 = tile.x;
        if (t2 < 10)
          if (t2 >= 0) {
            ...
            if (t3 < 20)
              if (t3 >= 0) {
                ...
                t3 = J.$eq$(J.$index$asx(t4[t2], t3), 1);
                t2 = t3;
              } else
                t2 = true;
            else
    ...
    pieceMoving$1: function(s) {
      var t1, t2, pieceIsMoving, _this = this;
      $.Game_ctx.fillStyle = "grey";
      C.JSArray_methods.forEach$1(_this.currentBlock.tiles, new V.Game_pieceMoving_closure());
      t1 = s === "rotate";
      ...
      if (t1)
        ...
        t2.move$1(s);
      pieceIsMoving = _this.validMove$0();
      if (!pieceIsMoving) {
        if (t1)
          _this.currentBlock.rotateLeft$0();
        if (s === "left")
          _this.currentBlock.move$1("right");
        if (s === "right")
          _this.currentBlock.move$1("left");
        if (s === "down")
          _this.currentBlock.move$1("up");
        if (s === "up")
          _this.currentBlock.move$1("down");
      }
      t1 = $.Game_ctx;
      t2 = _this.currentBlock;
      t1.fillStyle = t2.color;
      C.JSArray_methods.forEach$1(t2.tiles, new V.Game_pieceMoving_closure0());
      return pieceIsMoving;
    },
    updateGame$1: function(timer) {
      ...
      if (typeof console != "undefined")
        window.console.log(t1);
      t1 = _this.gameScore;
      t2 = "<p>Score: " + H.S($.Game_linesCleared) + " Lines</p>";
      t1.textContent = null;
      t1.appendChild(C.DivElement_methods.createFragment$3$treeSanitizer$validator(t1, t2, null, null));
      if (!_this.pieceMoving$1("down")) {
        C.JSArray_methods.forEach$1(_this.currentBlock.tiles, new V.Game_updateGame_closure());
        _this.clearRows$0();
        _this.currentBlock = _this.getRandomPiece$0();
        if (!_this.pieceMoving$1("down"))
          timer.cancel$0();
      }
    },
    handleKeyboard$1: function(timer) {
      var t1 = W.KeyboardEvent;
      W._EventStreamSubscription$(document, "keydown", H.functionTypeCheck(new V.Game_handleKeyboard_closure(this, timer), {func: 1, ret: -1, args: [t1]}), false, t1);
    }
  };
  V.Game_closure.prototype = {
    call$1: function(_) {
      H.intTypeCheck(_);
      return P.List_List$filled(20, 0, P.int);
    },
    $signature: 22
  };
  V.Game_clearRows_closure.prototype = {
    call$1: function(c) {
      J.$indexSet$ax(H.assertSubtype(c, "$isList", [P.int], "$asList"), 0, 0);
      return 0;
    },
    $signature: 23
  };
  V.Game_pieceMoving_closure.prototype = {
    call$1: function(tile) {
      var t1;
      H.interceptedTypeCheck(tile, "$isTile");
      $.Game_ctx.beginPath();
      ...
      t1.lineWidth = 2;
      t1.strokeStyle = "grey";
      t1.moveTo(tile.x * 30, tile.y * 30);
      $.Game_ctx.lineTo(tile.x * 30 + 30, tile.y * 30);
      $.Game_ctx.lineTo(tile.x * 30 + 30, tile.y * 30 + 30);
      $.Game_ctx.lineTo(tile.x * 30, tile.y * 30 + 30);
      $.Game_ctx.lineTo(tile.x * 30, tile.y * 30);
      $.Game_ctx.closePath();
      $.Game_ctx.stroke();
      $.Game_ctx.fillRect(tile.x * 30, tile.y * 30, 30, 30);
    },
    $signature: 2
  };
  V.Game_pieceMoving_closure0.prototype = {
    call$1: function(tile) {
      var t1;
      H.interceptedTypeCheck(tile, "$isTile");
      $.Game_ctx.beginPath();
  ...
  V.Game_updateGame_closure.prototype = {
    call$1: function(t) {
      var t1, t2, t3;
      H.interceptedTypeCheck(t, "$isTile");
      t1 = $.Game_boardState;
      t2 = t.x;
      if (t2 < 0 || t2 >= t1.length)
        return H.ioore(t1, t2);
      J.$indexSet$ax(t1[t2], t.y, 1);
      t2 = $.Game_rowState;
      t1 = t.y;
      t2.length;
      if (t1 < 0 || t1 >= 20)
      ...
      if (typeof t3 !== "number")
        return t3.$add();
      (t2 && C.JSArray_methods).$indexSet(t2, t1, t3 + 1);
    },
    $signature: 2
  };
  V.Game_handleKeyboard_closure.prototype = {
    call$1: function($event) {
      var t1, _this = this;
      H.interceptedTypeCheck($event, "$isKeyboardEvent");
      if (_this.timer._handle != null) {
        if ($event.keyCode === 37)
          _this.$this.pieceMoving$1("left");
        if ($event.keyCode === 38)
          _this.$this.pieceMoving$1("rotate");
        if ($event.keyCode === 39)
          _this.$this.pieceMoving$1("right");
        if ($event.keyCode === 40)
          _this.$this.pieceMoving$1("down");
        if ($event.keyCode === 32)
          for (t1 = _this.$this; t1.pieceMoving$1("down");)
            ;
      }
    },
    $signature: 24
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(V.Game.prototype, "get$updateGame", "updateGame$1", 21);
  })();
  (function inheritance() {
    ...
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.BaseElement, W.BodyElement, W.CanvasElement, W.DivElement, W.FormElement, W.SelectElement, W.TemplateElement]);
    ...
    _inheritMany(V.Block, [V.IBlock, V.OBlock, V.JBlock, V.LBlock, V.TBlock, V.ZBlock, V.SBlock]);
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: P.Null, args: [V.Tile]}, {func: 1, ret: P.int, args: [V.Tile]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, args: [,]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, args: [W.Event]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: -1, args: [P.Timer]}, {func: 1, ret: [P.List, P.int], args: [P.int]}, {func: 1, ret: P.int, args: [[P.List, P.int]]}, {func: 1, ret: P.Null, args: [W.KeyboardEvent]}], interceptorsByTag: null, leafTags: null};
  (function constants() {
...
;
  ...
  (function staticFields() {
    ...
    $.Game_linesCleared = null;
    $.Game_ctx = null;
    $.Game_boardState = null;
    $.Game_rowState = null;
  })();
...
//# sourceMappingURL=html_tetris.js.map
